...
-- Table `wechat`.`fans`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wechat`.`fans` ;

CREATE TABLE IF NOT EXISTS `wechat`.`fans` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `wx` VARCHAR(45) NOT NULL DEFAULT '' COMMENT '微信号id',
  `nickname` VARCHAR(45) NOT NULL DEFAULT '' COMMENT '昵称',
  `created_time` INT UNSIGNED NOT NULL DEFAULT 0 COMMENT '关注时间',
  `updated_time` INT UNSIGNED NOT NULL DEFAULT 0 COMMENT '解除关注时间',
...
CREATE TABLE IF NOT EXISTS `wechat`.`event` (
  ...
  INDEX `fk_message_fans1_idx` (`fans_id` ASC))
ENGINE = MyISAM
COMMENT = '事件';
...
CREATE TABLE IF NOT EXISTS `wechat`.`message_statistics` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_statistics_account1_idx` (`account_id` ASC),
  INDEX `fk_fans_statistics_fans1_idx` (`fans_id` ASC))
ENGINE = MyISAM
COMMENT = '被动回复消息统计';
...
CREATE TABLE IF NOT EXISTS `wechat`.`message` (
  ...
  `account_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_message_fans2_idx` (`fans_id` ASC),
